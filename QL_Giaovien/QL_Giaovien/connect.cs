...
namespace QL_BaoHanhTTDT
{
	class connect
	{
		...
		public void connection()
		{
			try
			{
				String constr = ConfigurationManager.ConnectionStrings["QL_BaoHanhTBDT"].ConnectionString;
		...
		public string ExcuteScalar(string stringSQL)
		{
			string giatri = "";
			try
			{
				connection();
				SqlCommand cmd = new SqlCommand(stringSQL, cnn);
